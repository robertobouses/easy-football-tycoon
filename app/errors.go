...
var ErrInvalidFormation = errors.New("La alineación no es válida, ajustar a formación establecida")
var ErrUnknownFormation = errors.New("Formación desconocida")
var ErrCalendaryDatesNoAvailable = errors.New("Fechas desconocidas")
